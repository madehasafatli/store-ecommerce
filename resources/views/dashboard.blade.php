                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="caption">
                                    ...
                                    <p>MakMa HTML Template can be converted into your desired CMS theme. Total <strong>5 pages</strong> included. You can use this Bootstrap v4.1.3 layout for any CMS.
